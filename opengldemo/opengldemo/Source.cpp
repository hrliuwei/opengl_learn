...
int main()
{
	...
	Shader shader((sPath + "frame.vs").c_str(), (sPath + "frame.fs").c_str());
	Shader shader_screen((sPath + "screen.vs").c_str(), (sPath + "screen.fs").c_str());
	...
	glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, nwndWidth, nwndHeight);
