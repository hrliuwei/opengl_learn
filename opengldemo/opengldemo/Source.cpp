...
//	glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
	...
	Shader simpleshader((sPath + "shadowmap.vs").c_str(), (sPath + "shadowmap.fs").c_str());
	Shader debugDepthQuad((sPath + "debugdepth.vs").c_str(), (sPath + "debugdepth.fs").c_str());
	Shader shader((sPath + "rendersc.vs").c_str(), (sPath + "rendersc.fs").c_str());
   ...
   // ------------------------------------------------------------------
	...
	simpleshader.use();
	simpleshader.setInt("floorTexture", 0);
	shader.use();
